...
public class ExampleHandler extends DefaultHandler {
	...
	} else if (localName.equals("Name") || localName.equals("Owner")
		|| localName.equals("Public") || localName.equals("Virtual")
	...
	if (this.in_mytag) {
	    Log.d("wattdroid",
		    "Found mytag...setting extractedStringInnerContent...");
	    myParsedExampleDataSet.setExtractedStringInnerContent(new String(
		    ch, start, length));
	}
    }
}
