...
/**
 * ParsedExample - Receives extracted contents of XML from Example Handler and
 * processes for the view.
 * 
 */
public class ParsedExampleDataSet {
	...
	sourceList.add(extractedString.substring(extractedString
		.lastIndexOf("/") + 1));
